  ...
  return (
    <footer className="bg-black/50 border-t border-white/10">
      <div className="container mx-auto px-4 py-8 text-center text-gray-400">
        <div className="mb-4">
            <p className="font-bold text-lg text-white">Pane & Caffè</p>
            <p><a href="https://www.panecaffe.info/" target="_blank" rel="noopener noreferrer" className="text-brand-orange hover:underline">Sito Ufficiale</a></p>
