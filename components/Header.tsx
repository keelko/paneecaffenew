      ...
      <div className="container mx-auto px-4 h-20 flex justify-between items-center">
        <div className="flex items-center">
          ...
          <button onClick={onScrollToTop} className="ml-4 group" aria-label="Torna in cima">
            <div className="relative">
                <span className="font-brand text-3xl tracking-wider text-brand-cream">PANE & CAFFÈ</span>
        ...
        <div className="flex items-center gap-4">
          ...
          >
            ...
            {cartItemCount > 0 && (
              <span className="absolute -top-1 -right-1 bg-brand-orange text-white text-xs font-bold rounded-full h-6 w-6 flex items-center justify-center animate-pulse">
                {cartItemCount}
              </span>
            )}
          </button>
