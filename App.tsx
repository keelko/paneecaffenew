...
const App: React.FC = () => {
  ...
  return (
    <div className="bg-brand-cream text-brand-dark min-h-screen font-sans">
      ...
      <main>
        {!isSearchActive && <Hero />}
        <div id="category-nav-container" className="sticky top-[calc(80px+env(safe-area-inset-top))] md:top-[calc(110px+env(safe-area-inset-top))] z-30 bg-brand-cream/90 backdrop-blur-sm shadow-sm border-b border-brand-red/10">
            <CategoryNav
